**Pink \- Updated, Grey \- In progress, Green \- Complete, Orange \- New**

**EPIC 001 \- ACCOUNT SERVICES**

**1\.	As any traveler, I want to create an account and login with my email, so I can save my trips and access them privately. \[SCRUM-22\]**
...
**2\. 	As a traveler, I want to create an account and log in with OAuth so I can access my trips. \[SCRUM-23\]**
...
**3\.	As any traveler I want my session to persist so I don’t have to log in repeatedly. \[SCRUM-24\]**
...
**4\.	As a traveler, I want to create and delete trips so I can plan effectively. \[SCRUM-25\]**
...
**5\.	As Priya and Noah, I want to see all my trips in an intuitive way so I don’t waste time. \[SCRUM-26\]**
...
2. Given I have no trips, then I see a clear empty-state message with a “Create Trip” button.  
3. Given I click on a trip, then I am redirected to its trip view.

**7\. As any traveller, if I have many Trips I want an easy way to sort them. \[SCRUM-52\]**

1. Given I have many trips, when I use search or sorting, then results update instantly without reloading the page.  
2. I should be able to sort by, start date, end date, number of events and location.

**EPIC 003 \- TRIP VIEW**

**8\.	As a traveler, I want to invite my friends on the trip and plan it together. \[SCRUM-27\]**

1. Given a trip is active, I can access the Trip view.  
2. Given I am in the Trip view, I can see the invite members button.  
3. Given I tapped the invite members button, \<I can add someone to the trip\>.

**9\. 	As Noah, I want to see all my events in a ‘Trip View’, where I can see an overview of the trip. \[SCRUM-29\]**
...
**10\.	As a traveler, I want to browse through the list of events in each day. \[SCRUM-28\]**
...
**11\. 	As any traveler I want to manage events in my trip overview(create, read, update, delete, and reorder) so my plans stay accurate. \[SCRUM-53\]**
...
3. Given I delete an event, then it is removed from the itinerary after confirmation.  
4. Given I hold-and-drag and reorder events, then the new order is saved and synced for all members.

8\. **As any traveller should be able to adjust my trip in case of new circumstances. \[SCRUM-54\]**
...
**12\. 	As any traveler I want to manage events in my calendar (create, read, update, delete, and reorder) so my plans stay accurate. \[SCRUM-30\]**

5. Given valid event details, when I save, then the event appears at the correct chronological position.  
6. Given I open an event, then full details (title, time, location, notes) are displayed.  
7. Given I delete an event, then it is removed from the itinerary after confirmation.  
8. Given I hold-and-drag and reorder events, then the new order is saved and synced for all members.

**13\. 	As any traveler, I want to see my itinerary in a calendar, so I can get a good idea of the timing of my events. \[SCRUM-31\]**
...
**14\. 	As any traveler, I want travel-time checks during planning that block saves and show an error if there isn’t enough time between events so my schedule stays feasible. \[SCRUM-32\]**
...
**15\.	As Noah, I want to navigate by transit efficiently with timetables taken into account so I catch the right connections. \[SCRUM-33\]**
...
**EPIC 005 \- MAP VIEW**  
**16\. 	As any traveler, I want to see my itinerary in a map view, so I can get a good idea of the location of my events. \[SCRUM-34\]**
...
**17\. 	As Alex, I want to see in the map the locations of my events, and see the transit route between any two locations so I can better decide the order of the events. \[SCRUM-35\]**
...
**18\. 	As Priya, I want to know how far away an event is from the next. \[SCRUM-36\]**

1. Given I am on the Calendar tab, I can see the transit icon.  
2. Given I tap on one of the transit icons, I will be redirected to the Transit view.  
3. Given I am in the Transit view, I can see estimated transit times and distances.

**19\.	As Noah, I want to see the location of others on my trip so we can coordinate in real time. \[SCRUM-37\]**
...
**20\.	As Priya, I want reminders and nudges to leave on time so I keep the group on schedule. \[SCRUM-38\]**
...
**21\.	As Priya, I want an AI summary of what I like so suggestions match my preferences. \[SCRUM-39\]**
...
**22\. As Priya, I want AI analytics (on-time rate, total travel time, distance, activity vs transit) so I can understand how the trip is going. \[SCRUM-40\]**
...
**23\. As Priya, I want the app to remember my preferences (pace, budget, preferred/avoided transport modes, favorite categories, default buffer time) so planning feels personalized. \[SCRUM-41\]**
