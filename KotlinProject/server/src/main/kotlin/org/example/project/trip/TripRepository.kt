...
interface TripRepository {
     ...
     */
    suspend fun allTripsByUser(userId: Int?): List<TripResponse>
     ...
     */
    suspend fun getTrip(tripId: Int?): TripResponse?
     ...
     */
    suspend fun addTrip(userId: Int?, tripDto: TripCreateRequest): Result<TripResponse>
     ...
     */
    suspend fun updateTrip(tripId: Int?, trip: Trip): Result<Boolean>
     ...
     */
    suspend fun deleteTrip(tripId: Int): Result<Boolean>
}