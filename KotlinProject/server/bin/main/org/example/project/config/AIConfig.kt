...
data class AIConfig(
    ...
    val maxTokens: Int = System.getenv("AI_MAX_TOKENS")?.toIntOrNull() ?: 350,
    val temperature: Double = System.getenv("AI_TEMPERATURE")?.toDoubleOrNull() ?: 0.9 // different ans variation
) {
    fun isValid(): Boolean {
